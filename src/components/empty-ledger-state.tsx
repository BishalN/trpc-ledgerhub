...
// TODO: proper type definition for icon component
...
export function EmptyLedgerState() {
  return (
    <div className="my-4 rounded-md bg-white p-2 text-center">
      <svg
      ...
      <h3 className="mt-2 text-sm font-medium text-gray-900">No ledger</h3>
      <p className="mt-1 text-sm text-gray-500">
        Get started by creating a new ledger.
      </p>
      <div className="mt-6">
        {/* <button
          type="button"
